...
@section('body')
                                        ...
                                        <div class="card wow mb-4 card-table card-dash">
                                            <div class="card-body body-card">
                                                <div class="d-flex justify-content-between flex-column flex-sm-row">
                                                    ...
                                                    <ul class="nav nav-tabs nav-switch mt-3 mt-sm-0 nav-mobile" id="myTab" role="tablist">
                                                        <li class="nav-item" role="presentation">
                                                            <button class="nav-link {{ $tab == 'home' || $tab == null ? 'active' : '' }}" id="home-tab" data-bs-toggle="tab"
                                                        ...
                                                        <li class="nav-item" role="presentation">
                                                            <button class="nav-link {{ $tab == 'historiques' ? 'active' : '' }}" id="profile-tab" data-bs-toggle="tab"
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-lg-12">
                                                        <div class="tab-content" id="myTabContent">
                                                            <div class="tab-pane {{ $tab == 'home' || $tab == null ? 'show active' : '' }} fade" id="home-tab-pane"
                                                                ...
                                                                @if ($devis->where('state',0)->count() == 0)
                                                                    <div class="block-empty mt-3 mt-md-5">
                                                                        ...
                                                                        <ul class="list">
                                                                            <li class="list-item"> Chercher les produits que vous voulez </li>
                                                                            <li class="list-item"> Ajoutez le au Panier </li>
                                                                            <li class="list-item"> Allez au Panier </li>
                                                                            <li class="list-item"> Ajuster le nombre que vous souhaitez </li>
                                                                            <li class="list-item"> Cliquez sur demandez devis</li>
                                                                        </ul>
                                                                    </div>
                                                                @else
                                                            ...
                                                            <div class="tab-pane {{ $tab == 'historiques' ? 'show active' : '' }} fade" id="historiques"
                                                                role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                                                @if ($devis->where('state',1)->count() == 0)
                                                                    <div class="block-empty mt-3 mt-md-5">
                                                                        ...
                                                                        <ul class="list">
                                                                            ...
                                                                            <li class="list-item"> Allez au Panier </li>
                                                                            <li class="list-item"> Cliquez sur demandez devis</li>
                                                                            <li class="list-item"> Attendez la reponse de PHARMANS</li>
                                                                        </ul>
                                                                    </div>
                                                                @else
                                                                    <div class="row row-action">
    ...
    <div class="offcanvas  offcanvas-end" tabindex="-1" id="offcanvas-demande-{{ $devi->id }}" aria-labelledby="offcanvasRightLabel"
        style="width: 700px">
            {{-- <form action="{{route('commandes.passer')}}" class="devis"> --}}
            <div class="offcanvas-header px-md-4">
                <h5 class="offcanvas-title" id="offcanvasRightLabel">
                    {{ $devi->title }}-{{ $devi->created_at->format('d-m-Y') }} </h5>
                            ...
                            <div class="col-lg-2 d-flex justify-content-end">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="{{route('commandes.devis.delete', $devi->id)}}">Supprimer</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
