                        ...
                        <div id="carouselExampleIndicators-1" class="carousel slide" data-bs-ride="true">
                            ...
                            <div class="carousel-indicators">
                                <button type="button" data-bs-target="#carouselExampleIndicators-1" data-bs-slide-to="0"
                                    ...
                                    <img src="{{ asset('assets/images/produits/' . $produit->first_image) }}" alt="Photo de"
                                        class="img-product">
                                </button>
                            ...
                            {{-- <div class="block-img-prod">
                            <img src="{{ asset('assets/images/produits/'.$produit->first_image) }}" alt="Photo de" class="img-product">
                        </div> --}}
                        </div>
                    </div>
                    <div class="col-lg-6">
                        ...
                        @if ($produit->fichier != null)
                            <div>
                                <h4>Fichier joint</h4>
                                <a href="{{ asset('assets/images/produits/fichier/' . $produit->fichier) }}" target="_blanck"
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="profile-tab-pane-4" role="tabpanel"
                                ...
                                @if ($produit->fichier)
                                    ...
                                    <a href="{{ asset('assets/images/produits/fichier/' . $produit->fichier) }}"
                                        target="_blanck" class="link ">
