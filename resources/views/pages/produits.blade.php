                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                        ...
                        <div class="row g-lg-5 g-3">
                            ...
                            @endforeach
                            <div class="col-12  2 me-auto ms-auto  ">
                                <style>
                                ...
                                <h2 class="text-center mb-5 fadeUp wow animate__animated animate__fadeIn mt-3 mt-md-4">
                                    {{ $produits->links() }}
                                </h2>
                            </div>
...
<div class="block-search">
    <form method="get" action="{{ route('produits.recherche') }}">
        ...
        <div class="input-group">
            ...
            <button class="btn btn-outline-secondary" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i
                    class="bi bi-filter"></i></button>
            <ul class="dropdown-menu dropdown-menu-end">
                @foreach ($categories as $categorie)
                    <li><a class="dropdown-item {{ $categorie->id == $active ? 'produit' : '' }}"
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('devis.store') }}">
                    ...
                    <div class="form-group row g-lg-4 g-2">
                        ...
                        <div class="col-lg-6 col-12 col-md-6">
                            <input type="text" class="form-control" name="societe" placeholder="Entreprise" value="">
                        </div>
                        <div class="col-lg-6 col-12 col-md-6">
