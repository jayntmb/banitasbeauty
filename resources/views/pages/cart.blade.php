                                ...
                                <div class="col-lg-2 col-4 col-sm-2">
                                    <div class="img-product">
                                        <a href="{{ route('detal-product', [$panier->produit->id]) }}">
                                            <img src="{{ asset('assets/images/produits/'.$panier->produit->image) }}" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-lg-10 col-8 col-sm-10">
                                    <div class="row g-3">
                                        <div class="col-lg-4 col-sm-4">
                                            ...
                                            <a href="{{ route('produits.categorie', [$panier->produit->categorie->libelle, $panier->produit->categorie->id]) }}">
                                                <p>{{ $panier->produit->categorie->libelle }}</p>
                                            </a>
                                        </div>
                                        <div class="col-lg-4 col-sm-4">
                                            <div class="d-flex justify-content-start justify-content-lg-center align-items-center">
                                        ...
                                        <div class="col-lg-4 text-start text-lg-center col-sm-4">
                                            <a href="{{ route('panier.delete', [$panier->produit->id]) }}" class="btn btn-delete ps-0">Supprimer</a>
                                        </div>
                                    </div>
                                </div>
