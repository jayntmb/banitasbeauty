                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    ...
                                    {{-- <div class="form-group w-25 d-flex mb-0">
                                        <input type="text" class="form-control" placeholder="Recherche ici..."
                                            ...
                                            <tbody>
                                                @foreach ($produits as $key => $produit)
                                                    <tr data-toggle="modal" data-target="#ModalUser_{{ $key }}">
                                                        <td><img src="{{ asset('storage/images/produits/' . $produit->first_image) }}"
                                                                alt=""></td>
                                                        <td>{{ $produit->nom }}</td>
                        ...
                        <div class="card wow">
                            <div class="card-body">
                                <h4 style="font-size: 20px;">
                                    {{ $article != null ? 'Modifier un produit' : 'Ajouter un produit' }}
                                </h4>
                                <hr>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-12">
                                            ...
                                            <textarea name="description" id="description" class="form-control"
                                                placeholder="Entrez la description du produit">{{ $article != null ? $article->description : '' }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-lg-12">
                                            <label for="posologie">Posologie du produit</label>
                                            <textarea name="posologie" id="posologie" class="form-control"
                                                placeholder="Entrez la posologie du produit">{{ $article != null ? $article->posologie : '' }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-12">
                                            ...
                                            <select name="statut_id" id="statut" class="form-control">
                                                <option value="1" {{ $article != null && $article->statut_id == '1' ? 'selected' : '' }}>
                                                    Actif </option>
                                                <option value="2" {{ $article != null && $article->statut_id == '2' ? 'selected' : '' }}>
                                                    Inactif </option>
                                                <option value="3" {{ $article != null && $article->statut_id == '3' ? 'selected' : '' }}>
                                                    En attente </option>
                                            </select>
                                        </div>
                                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body detail-act">
                    <div class="card">
                        <div class="card-img">
                            <img src="{{ asset('storage/images/produits/' . $produit->first_image) }}" alt=""
                                class="img-fluid">
                        </div>
                        <div class="card-body">
                            <div class="text-left">
