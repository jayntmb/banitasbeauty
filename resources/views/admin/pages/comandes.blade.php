                                    ...
                                    <div class="demande">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-3 ms-auto ps-0">
                                                ...
                                                <p>Total :  {{ (int)$commande->prix * (int)$commande->quantite }} {{$commande->devise->symbole}}</p>
                                ...
                                @foreach ($commande->devis->commandes as $com)
                                    <div class="bock-lits-demande">
                                        <div class="demande">
                                            <div class="row align-items-center">
                                                <div class="col-2 pe-0">
                                                    <img src="{{ asset('assets/images/produits/' . $com->produit?->image) }}"
                                                        alt="">
                                                </div>
                                                <div class="col-6">
