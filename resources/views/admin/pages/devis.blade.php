                                    ...
                                    <ul class="nav nav-tabs nav-switch mt-3 mt-sm-0" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="profile-tab" data-bs-toggle="tab"
                                                ...
                                                aria-controls="profile-tab-pane" aria-selected="false">Devis
                                                traités</button>
                                        </li>
                                    </ul>
                    ...
                    @if ($user->devisclient->count() > 0)
                                ...
                                @foreach ($userdevis as $devisclient)
                                    <div class="col-6 mb-3">
                                        <h5 class="mb-0" style="font-size: 16px; color: #222423;font-weight:600;">{{ $devisclient->title }}
                                        </h5>
                                        <span
                                            style="font-size: 12px; color: #8f9794;">{{ $devisclient->created_at->diffForHumans() }}</span>
                                    </div>
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-4 ms-auto ps-0 col-sm-4">
                                                        ...
                                                        <div class="input-group flex-nowrap flex-sm-wrap">
                                                            <input type="text" class="form-control w-50" placeholder="Prix" name="price[]"
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-4 ms-auto ps-0 col-sm-4">
                                    <div class="input-group flex-nowrap flex-sm-wrap">
                                        ...
                                        <input type="text" value="{{$commande->devise->symbole}}" class="form-control w-25"
                                            readonly>
                                    </div>
                                </div>
                            </div>
