                                ...
                                <div class="card card-hover wow h-100">
                                    <div class="card-body pb-0">
                                        ...
                                        <div class="text-left">
                                            ...
                                            <h1 class="mt-0 mt-sm-2 mt-lg-5">{{ $commandes->where('statut_id', 2)->count() }}</h1>
                                            <h5 class="mt-2 mt-sm-2 mt-lg-4 d-flex align-items-center justify-content-end mb-0 total">
                                                <span>Total : </span><span class="ms-1"> {{ $commandes->count() }}</span>
                                            </h5>
                                            {{-- <p style="font-size: 14px;"
                                                class="mt-4"><span class=""><i
                                                            ...
                                                            <div
                                                                ...
                                                                @php
                                                                    $cmmd = App\Models\Commande::where('user_id', $devi->user->id)
                                                                        ->get()
                                                                        ->count();
                                                                    $repCmmd = App\Models\Commande::where('user_id', $devi->user->id)->where('state', 0)->get()
