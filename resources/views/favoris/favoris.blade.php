                            ...
                            @foreach ($wishlists as $item)
                                <div class="col-lg-4 col-xl-3">
                                    <div class="card card-article">
                                        <div class="card-img">
                                            <a href="" onclick="removeFromWishlist({{ $item->id }})" class="like tooltip-hover liked" data-position-tooltip="right">
                                            ...
                                            <a href="{{ route('produit.show', $item->produit->id) }}">
                                                <img src="{{ asset('/assets/images/produits/' . $item->produit->first_image) }}" alt="image d'article">
                                            </a>
                                        </div>
