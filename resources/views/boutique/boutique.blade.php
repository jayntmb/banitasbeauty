    ...
    $averageRating = $produit->averageRating();
                                        ...
                                        <div class="col-lg-4 col-xl-3">
                                            <div class="card card-article">
                                                <div class="card-img">
                                                    <a href="" onclick="addToWishList(event, {{ $produit->id }})" class="like tooltip-hover"
                    ...
                    @foreach ($categories->skip(1) as $category)
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="tab-2" data-bs-toggle="tab" data-bs-target="#tab-pane-2"
                                type="button" role="tab" aria-controls="tab-pane-2" aria-selected="false">
                                {{ $category->libelle }}
                            </button>
                        </li>
                    @endforeach
            ...
            <div class="col-lg-12 px-lg-0">
                <div class="tab-content" id="myTabContent">
                    ...
                    @foreach ($categories->skip(1) as $categorie)
                        <div class="tab-pane" id="tab-pane-2" role="tabpanel" aria-labelledby="tab-2" tabindex="0">
                            <div class="content-card-articles d-flex align-items-center">
                                @if ($arrivages->isEmpty())
                                    <div class="alert alert-info w-100">
                                        Aucun arrivage disponible
